<div class="p-3 overflow-y-auto w-1/3">
        ...
        <div class="grid grid-cols-3">
            <?php foreach ($texts as $text): ?>
                <div class="mt-2 bg-slate-100 p-2 rounded-md">
                    ...
                    <button class="btn-primary">Text auswählen</button>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
    <div class="mt-2">
        ...
        <div class="mt-2 bg-slate-100 p-3 rounded-md selectTextStyle">
            ...
            <button class="btn-primary mt-1">Lustig</button>
            <button class="btn-primary mt-1">Ernst</button>
            <button class="btn-primary mt-1">Informativ</button>
            <button class="btn-primary mt-1">Für Gewerbetreibende</button>
            <button class="btn-primary mt-1">Für Privat</button>
            <button class="btn-primary mt-1">Hobbyaufkleber</button>
            <button class="btn-primary mt-1">Traurig</button>
            <button class="btn-primary mt-1">Bayrisch</button>
        </div>
        ...
        <button class="btn-primary mt-2" data-binding="true" data-fun="textGenerationExtended" id="generateNewText">Neuen Text generieren</button>
    </div>
</div>